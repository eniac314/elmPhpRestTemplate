...
var $author$project$Internal$Logger$hashLog = F2(
	function (seed, log) {
		var _v0 = A2(
		...
		var hash = A2(
			...
			_Utils_ap(
				log.message,
				_Utils_ap(
					A2($elm$core$Maybe$withDefault, '', log.mbDetails),
					_Utils_ap(
						log.isError ? 'isError' : 'isNotError',
						_Utils_ap(
							log.isImportant ? 'isImportant' : 'isNotImportant',
							$elm$core$String$fromInt(
								$elm$time$Time$posixToMillis(log.timeStamp)))))));
...
var $author$project$Internal$Logger$safeInsert = F4(
	function (f, k, v, d) {
		safeInsert:
		while (true) {
...
var $author$project$Internal$Logger$Log = F5(
	function (message, mbDetails, isError, isImportant, timeStamp) {
		return {isError: isError, isImportant: isImportant, mbDetails: mbDetails, message: message, timeStamp: timeStamp};
	});
var $author$project$Internal$Logger$newLog = F5(
	function (addLogMsg, logMsg, details, isError, isImportant) {
		return A2(
			...
			A2(
				...
				function (t) {
					return $elm$core$Task$succeed(
						A5($author$project$Internal$Logger$Log, logMsg, details, isError, isImportant, t));
				},
				$elm$time$Time$now));
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'ChangeUrl':
				var url = msg.a;
				var _v2 = A2($elm$url$Url$Parser$parse, $author$project$Main$pathParser, url);
				if (_v2.$ === 'Just') {
					var _v3 = _v2.a;
					var path = _v3.a;
					var mbAnchor = _v3.b;
			...
			case 'AddLog':
				var log = msg.a;
				var _v4 = A2($author$project$Internal$Logger$hashLog, model.seed, log);
				var logHash = _v4.a;
				var newSeed = _v4.b;
				var newLogs = A4(
					$author$project$Internal$Logger$safeInsert,
					function (k) {
						return k + 1;
					},
					logHash,
...
var $author$project$Style$Palette$grey = $author$project$Style$Palette$colorConv($avh4$elm_color$Color$grey);
...
var $author$project$Style$Palette$white = $author$project$Style$Palette$colorConv($avh4$elm_color$Color$white);
...
var $author$project$Style$Helpers$buttonStyle = function (isActive) {
	return _Utils_ap(
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$centerX,
				$mdgriffith$elm_ui$Element$padding(10),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Style$Palette$white),
		...
		isActive ? _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Background$color($author$project$Style$Palette$grey)
					]))
			]) : _List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('this is home')
						]))),
				_Utils_Tuple2(
				'/auth',
				A2(
